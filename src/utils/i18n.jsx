...
const TRANSLATIONS = {
  en: {
    ...
    'outline.reviewSubtitle': "Edit anything below — nothing generates automatically. You'll trigger each episode's script, sprites, backgrounds, and narration yourself, one step at a time.",
  ...
  th: {
    ...
    'outline.reviewSubtitle': 'แก้ไขได้ตามต้องการ — ไม่มีอะไรสร้างอัตโนมัติ คุณจะเป็นคนกดเริ่มแต่ละขั้นตอน (บท สไปรท์ พื้นหลัง เสียงพากย์) ของแต่ละตอนเอง',
